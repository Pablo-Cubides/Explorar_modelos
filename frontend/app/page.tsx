...
// Datos embebidos para evitar dependencias de red
const data = {
  "buckets": {
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const startId = window.setTimeout(tick, stepMs)
    return () => {
      cancelled = true
      ...
      <section className="grid grid-cols-1 gap-6 md:grid-cols-3">
        ...
        <div className="md:col-span-2">
          <div className="p-6 border border-gray-800 rounded-lg shadow-sm bg-surface">
            ...
            <div className="mt-3 text-2xl md:text-3xl leading-relaxed font-medium whitespace-pre-wrap min-h-[8rem]">
              {displayed}
